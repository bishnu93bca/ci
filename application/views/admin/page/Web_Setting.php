              ...
              <table id="example1" class="table table-bordered table-striped">
               ...
               <?php 
                ...
                <tr>
                      ...
                      <td>
                          <a href="<?php echo base_url() ?>user/Web_Setting/<?php echo $row->user_id ?>" title="EDIT" ><span class="label label-warning"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></span></a>
                          &nbsp;
                          <a onclick="return confirm('Are you sure you want to delete this User?');" href="<?php echo base_url() ?>user/Web_setting/<?php echo $row->user_id ?>" title="DELETE" ><span class="label label-danger"><i class="fa fa-trash-o" aria-hidden="true"></i></span></a>
