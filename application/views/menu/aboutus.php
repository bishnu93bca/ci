            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-5">
                    <div class="testimonial-cont">
                        ...
                        <div class="entry-footer d-flex flex-wrap align-items-center mt-5">
                            <img src="<?php echo base_url();?>assets1/images/testimonial-1.jpg" alt="">
                ...
                <div class="col-12 col-md-6 offset-lg-2 col-lg-5">
                    <div class="testimonial-cont">
                        ...
                        <div class="entry-footer d-flex flex-wrap align-items-center mt-5">
                            <img src="<?php echo base_url();?>assets1/images/testimonial-2.jpg" alt="">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 d-flex flex-wrap justify-content-between align-items-center">
                    ...
                    <a class="btn orange-border" href="<?php echo base_url();?>assets1/#">Donate now</a>
                </div>
            </div>
        </div>
    </div>
